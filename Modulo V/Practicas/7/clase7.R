...
# Parámetros:
N = 4         # Numero de la poblacion cerrada
...
# ============== Generador de trayectorias en procesos de saltos de MArkov ================== #

# para este modelos; vamos a considerar el el hecho de que deseamos ver los salto que realiza 
    # esta cadena (a tiempo continuo), a qu tiempo y en un lapso de tiempo en concreto
...
HT = 10       # "HT": el tiempo de horizonte (lapso de tiempo que deseamos ver)
